...
int main (int argc, char *argv[])
{
    ...
    GOptionEntry main_entries[] =
    {
        ...
        { "rtp_port", 0, 0, G_OPTION_ARG_INT, &rtp_port, "Specify optional RTP port number, 9999 by default", "rtp_port"},
        { NULL }
    };
    ...
    auto sink = new MiracSink (
        hostname, static_cast<int>(rtsp_port), static_cast<int>(rtp_port));
